...
function Team() {
  return (
    <div className="  mb-10 w-full p-6 lg:max-w-[1200px] lg:mx-auto md:p-5 ">
      <div className=" text-[#1E1E1E] p-3 space-y-5 mb-4 flex flex-col  items-center">
        <h1 className="font-bold text-[36px] leading-[72px]">Our Team</h1>
        <p className=" font-normal text-[14px] leading-[112.5%] text-left md:text-justify md:text-24px">
