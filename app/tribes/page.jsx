        ...
        <div className="container mx-auto p-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
            ...
            <div className="gap-[70px]">
              <p className="mr-24 p-4 font-normal text-[#2B2B2B] text-justify leading-[22.5px] text-sm">
                ...
                eros quis urna. Nunc viverra Lorem ipsum dolor sit amet,
              ...
              <div className="px-4 py-2 bg-cyan-500 rounded-[30px] mt-4 mr-10 inline-block">
                <div className="text-stone-900 text-[18px] font-bold font-['Calibri'] leading-7">
                  Learn more
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mt-6">
            ...
            <div className="gap-[70px]">
              ...
              <div className="px-4 py-2 bg-cyan-500 rounded-[30px] mt-4 inline-block">
                <div className="text-stone-900 text-[18px] font-bold font-['Calibri'] leading-7">
                  Learn more
                </div>
              </div>
